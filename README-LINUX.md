...
Next: [Finish Local Linux Setup](#finish-local-linux-setup).
...
Next: choose [Remote Linux Direct Process](#remote-linux-direct-process) or [Linux Service Commands With systemd](#linux-service-commands-with-systemd).
